...
stilts tmatch2 \
	...
	ofmt=fits-basic omode=out out=DR4AllDetections_inUnKnownEllipses
...
stilts tcat in='DR4AllDetections_inKnownEllipses DR4AllDetections_inUnKnownEllipses' \
...
rm DR4AllDetections_inUnKnownEllipses
...
# To do this, I first read all the SRCID of objects with EPIC luminosities
# surpassing the ULX threshold. Then I include all detections with a
# corresponding SRCID.
stilts tpipe in=DR4AllDetections_inGalaxies_nonCentral_noQSOnoSO_lowFlag \
...
stilts tmatch2 \
	in1=DR4AllDetections_inGalaxies_nonCentral_noQSOnoSO_lowFlag \
	in2=DR4_ULXcandidateDetections \
	matcher=exact join=1and2 find=best1 \
	values1='SRCID' values2='SRCIDlist' \
	ocmd='delcols SRCIDlist' \
	ofmt=fits-basic omode=out out=DR4_ULXcandidateDetections
# Only the brightest ones. Same procedure, but with higher luminosity threshold.
stilts tpipe in=DR4AllDetections_inGalaxies_nonCentral_noQSOnoSO_lowFlag \
...
stilts tmatch2 \
	...
	ofmt=fits-basic omode=out out=DR4_BrightDetections
# Leave only Sources
stilts tmatch1 in=DR4AllDetections_inGalaxies_nonCentral_noQSOnoSO_lowFlag \
