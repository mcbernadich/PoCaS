...
stilts cdsskymatch \
	...
	ofmt=fits-basic omode=out out=XMM_noNuclear_GaiaStars \
	...
	ocmd='replaceval "1" "GaiaDR2_Star" "OBJ_TYPE"' \
...
stilts tmatch1 \
	in=XMM_noNuclear_GaiaStars \
	icmd='sort SC_MatchDist' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_GaiaStars \
	values='DET_PGC_ID' action=keep1 matcher=exact
# Select the entries in XMM_XMM_noPotentiallyNuclear that do NOT appear in XMM_noNuclear_GaiaStars
# Do so by comparing DET_PGC_ID.
# Store the, in XMM_noNuclear_noGaiaStars. The meaning of the name is straightforward.
stilts tmatch2 \
	in1=XMM_noPotentiallyNuclear \
	in2=XMM_noNuclear_GaiaStars \
	find=all fixcols=none join=1not2 matcher=exact \
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars
# Give XMM_noNuclear_GaiaStars back the columns not realated to the contaminants.
# Concatenate the columns of all entries in XMM_noPotentiallyNuclear appearing in XMM_noNuclear_GaiaStars.
# XMM_noNuclear_GaiaStars and XMM_noNuclear_noGaiaStars have now the same dimensions.
stilts tmatch2 \
	in1=XMM_noPotentiallyNuclear \
	in2=XMM_noNuclear_GaiaStars \
...
# XMM_noNuclear_GaiaStars is stored and ignored until the end.
# XMM_noNuclear_noGaiaStars is passed down to the folowing filtering steps.
echo "------------------------------------------------------------------------------------"
...
stilts tmatch2 \
	in1=XMM_noNuclear_noGaiaStars \
	in2=Tycho2/Tycho2 \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_Tycho2 \
...
stilts tmatch1 \
	in=XMM_noNuclear_noGaiaStars_Tycho2 \
	icmd='sort SC_MatchDist' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_Tycho2 \
	values='DET_PGC_ID' action=keep1 matcher=exact
stilts tmatch2 \
	in1=XMM_noNuclear_noGaiaStars \
	in2=XMM_noNuclear_noGaiaStars_Tycho2 \
	find=all fixcols=none join=1not2 matcher=exact \
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2
stilts tmatch2 \
	in1=XMM_noNuclear_noGaiaStars \
	in2=XMM_noNuclear_noGaiaStars_Tycho2 \
	find=all fixcols=none join=1and2 matcher=exact \
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_Tycho2
rm XMM_noNuclear_noGaiaStars
# XMM_noNuclear_noGaiaStars_Tycho2 is stored and ignored until the end.
# XMM_noNuclear_noGaiaStars_noTycho2 is passed down to the folowing filtering steps.
echo "------------------------------------------------------------------------------------"
...
stilts tmatch2 \
	in1=XMM_noNuclear_noGaiaStars_noTycho2 \
...
stilts tmatch2 \
	...
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out out=XMM_SDSSQSO
rm XMM_noNuclear_noGaiaStars_noTycho2
...
stilts tmatch2 \
	...
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_VeronQSO \
...
stilts tmatch2 \
	in1=XMM_noSDSSQSO \
	in2=XMM_noNuclear_noGaiaStars_noTycho2_VeronQSO \
	find=all fixcols=none join=1not2 matcher=exact \
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO
stilts tmatch2 \
	in1=XMM_noSDSSQSO \
	in2=XMM_noNuclear_noGaiaStars_noTycho2_VeronQSO \
	find=all fixcols=none join=1and2 matcher=exact \
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_VeronQSO
# XMM_noNuclear_noGaiaStars_noTycho2_VeronQSO is stored and ignored until the end.
# XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO is passed down to the folowing filtering steps.
...
rm XMM_noSDSSQSO
echo "------------------------------------------------------------------------------------"
echo "We look again into Gaia to find objects of extragalactic origin."
echo "------------------------------------------------------------------------------------"
# Same method as for stars, but with log(fx/fv)<0.
stilts cdsskymatch \
	in=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_GaiaExtra \
	find=all fixcols=dups suffixin=null suffixremote=_GDR2 \
	ra='SC_RA' dec='SC_DEC' radius=10 cdstable='I/345/gaia2' \
	ocmd='replaceval null 9999999 phot_g_mean_mag' \
	...
	ocmd='replaceval "1" "GaiaDR2" "CONT_FLAG"' \
	ocmd='addcol "OBJ_TYPE" "toString(1.)"' \
	ocmd='replaceval "1" "GaiaDR2_Nuclear" "OBJ_TYPE"' \
	ocmd='addcol "SC_MatchDist" "skyDistanceDegrees(SC_RA,SC_DEC,RA_GDR2,DEC_GDR2)*3600"' \
	ocmd='select "3*(SC_POSERR+max(ra_error,dec_error)/1000)>SC_MatchDist"' \
	ocmd='addcol "MatchDist" "skyDistanceDegrees(RA,DEC,RA_GDR2,DEC_GDR2)*3600"' \
	ocmd='keepcols "DET_PGC_ID CONT_FLAG source_id RA_GDR2 DEC_GDR2 OBJ_TYPE MatchDist SC_MatchDist"' \
	...
	ocmd='colmeta -name "DEC_CONT" "DEC_GDR2"'
stilts tmatch1 \
	in=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_GaiaExtra \
	icmd='sort SC_MatchDist' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_GaiaExtra \
	values='DET_PGC_ID' action=keep1 matcher=exact
stilts tmatch2 \
	in1=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO \
	in2=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_GaiaExtra \
	find=all fixcols=none join=1not2 matcher=exact \
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noGaiaExtra
stilts tmatch2 \
	in1=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO \
	in2=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_GaiaExtra \
	find=all fixcols=none join=1and2 matcher=exact \
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_GaiaExtra
rm XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO
echo "------------------------------------------------------------------------------------"
...
# Store them in XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBAD.
stilts cdsskymatch \
	in=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noGaiaExtra \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBAD \
...
# XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBAD is used in the two following steps to extract contaminants two times.
echo "------------------------------------------------------------------------------------"
echo "Finding stars in SIMBAD."
echo "------------------------------------------------------------------------------------"
# Extract stellar objects from XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBAD
...
# Sort by ascending SC_MatchDist.
# Keep the contaminant columns.
# Store them in XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADstars.
stilts tmatch1 in=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBAD \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADstars \
	...
	icmd='sort SC_MatchDist' \
	values='DET_PGC_ID' action=keep1 matcher=exact
# Select all entries from XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO appearing in XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADstars.
# Do so by comparing DET_PGC_ID.
# Store them in XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBADstars.
stilts tmatch2 \
	in1=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noGaiaExtra \
	in2=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADstars \
	find=all fixcols=none join=1not2 matcher=exact \
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBADstars
# Concatenate the columns of entries in XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO apearing in XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADstars to give the fale the same dimensionality as the rest of the catalogue.
stilts tmatch2 \
	in1=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noGaiaExtra \
	in2=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADstars \
	find=all fixcols=none join=1and2 matcher=exact \
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADstars
rm XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noGaiaExtra
# XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADstars is stored and ignored until the end.
# XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBADstars is passed down to the folowing filtering steps.
echo "------------------------------------------------------------------------------------"
echo "Finding stars and AGNs in SIMBAD."
echo "------------------------------------------------------------------------------------"
# Extract other contaminants XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBAD
...
stilts tmatch1 in=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBAD \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADagn \
	...
	values='DET_PGC_ID' action=keep1 matcher=exact
stilts tmatch2 \
	in1=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBADstars \
	in2=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADagn \
	find=all fixcols=none join=1not2 matcher=exact \
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD
stilts tmatch2 \
	in1=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBADstars \
	in2=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADagn \
	find=all fixcols=none join=1and2 matcher=exact \
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADagn
rm XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBADstars
rm XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBAD
# XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADagn is stored and ignored until the following section.
# XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD is passed down to the following filtering steps.
echo "------------------------------------------------------------------------------------"
...
stilts cdsskymatch \
	in=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD \
	ofmt=fits-basic omode=out \
	out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_PanSTARRS1 \
...
# Sort by ascending order of SC_MatchDist.
# Perform a tmatch1 search of DET_PGC_ID with action=keep1 to keep only the closest match. 
stilts tmatch1 in=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_PanSTARRS1 \
	ofmt=fits-basic omode=out \
	out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_PanSTARRS1 \
	...
	icmd='sort SC_MatchDist' \
	values='DET_PGC_ID' action=keep1 matcher=exact
# Subtract all entries in XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_PanSTARRS1 from XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD.
# Store the reminder in XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_noPanSTARRS1.
stilts tmatch2 \
	in1=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD \
	in2=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_PanSTARRS1 \
	find=all fixcols=none join=1not2 matcher=exact \
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out \
	out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_noPanSTARRS1
# Concatenate the columns of XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_PanSTARRS1 with the entries appearing in XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD to give the same dimesionality to the file.
stilts tmatch2 \
	in1=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD \
	in2=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_PanSTARRS1 \
	find=all fixcols=none join=1and2 matcher=exact \
	values1='DET_PGC_ID' values2='DET_PGC_ID' \
	ofmt=fits-basic omode=out out=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_PanSTARRS1
rm XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD
# XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_PanSTARRS1 is stored to the next step.
# XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_noPanSTARRS1 is stored to the next step.
echo "------------------------------------------------------------------------------------"
...
stilts tcatn \
	nin=11 \
	in1=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_noPanSTARRS1 \
	in2=XMM_Nuclear \
	in3=XMM_PotentiallyNuclear \
	in4=XMM_noNuclear_GaiaStars \
	in5=XMM_noNuclear_noGaiaStars_Tycho2 \
	in6=XMM_SDSSQSO \
	in7=XMM_noNuclear_noGaiaStars_noTycho2_VeronQSO \
	in8=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_GaiaExtra \
	in9=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADstars \
	in10=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADagn \
	in11=XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_PanSTARRS1 \
	icmd1='addcol "DET_PGC_ID" "DET_PGC_ID"' \
	icmd1='addcol "CONT_FLAG" "toString(1.)"' \
...
rm XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_noPanSTARRS1
rm XMM_noNuclear_GaiaStars
rm XMM_noNuclear_noGaiaStars_Tycho2
rm XMM_noNuclear_noGaiaStars_noTycho2_VeronQSO
rm XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_GaiaExtra
rm XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADstars
rm XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_SIMBADagn
rm XMM_noNuclear_noGaiaStars_noTycho2_noVeronQSO_noSIMBAD_PanSTARRS1
rm XMM_Nuclear
rm XMM_SDSSQSO
