...
stilts tmatch2 \
	...
	in2=3XMM-DR4/3XMM-DR4_summary.fits.gz \
	find=best1 fixcols=dups suffix1=_HEC suffix2=_summ join=1and2 matcher=sky \
	values1='RA DEC' values2='RA DEC' params=900 \
	icmd1='select "R1<15"' \
	ofmt=fits-basic omode=out out=Good_RC3_CNG_5sec_NED_30sec_KnownDist_minDlt25min_summaryDR4_30min \
# Split the list of observations according to whether the shape of galaxies is known or not.
stilts tpipe \
	in=Good_RC3_CNG_5sec_NED_30sec_KnownDist_minDlt25min_summaryDR4_30min \
	out=Good_RC3_CNG_5sec_NED_30sec_KnownDist_minDlt25min_summaryDR4_30min_knownEllipses \
	ofmt=fits-basic cmd='select "PA!=0."'
stilts tpipe \
	in=Good_RC3_CNG_5sec_NED_30sec_KnownDist_minDlt25min_summaryDR4_30min \
	out=Good_RC3_CNG_5sec_NED_30sec_KnownDist_minDlt25min_summaryDR4_30min_unKnownEllipses \
	cmd='replaceval null 0. "PA"' \
	ofmt=fits-basic cmd='select "PA==0."'
rm Good_RC3_CNG_5sec_NED_30sec_KnownDist_minDlt25min_summaryDR4_30min
# Correlate galaxies with Detections.
# All detections within the known ellipse of a galaxy are flagged as "MATCH_FLAG=ell".
stilts tmatch2 \
	in1=3XMM-DR4/DR4_pointlikely \
	in2=Good_RC3_CNG_5sec_NED_30sec_KnownDist_minDlt25min_summaryDR4_30min_knownEllipses \
	...
	ofmt=fits-basic omode=out out=DR4AllDetections_inKnownEllipses
rm Good_RC3_CNG_5sec_NED_30sec_KnownDist_minDlt25min_summaryDR4_30min_knownEllipses
# For galaxies without a position angle, detections inside of the minor circle are flagged
# as "MATCH_FLAG=minor". Detections in the ring between the minor and minor radius are
# flagged with "MATCH_FLAG=major"
stilts tmatch2 \
	in1=3XMM-DR4/DR4_pointlikely \
	in2=Good_RC3_CNG_5sec_NED_30sec_KnownDist_minDlt25min_summaryDR4_30min_unKnownEllipses \
	find=best1 fixcols=dups suffix1=null suffix2=_summ join=1and2 matcher=skyellipse \
	...
	ofmt=fits-basic omode=out out=DR4AllDetections_inUnKnownEllipses_minor
stilts tmatch2 \
	in1=3XMM-DR4/DR4_pointlikely \
	in2=Good_RC3_CNG_5sec_NED_30sec_KnownDist_minDlt25min_summaryDR4_30min_unKnownEllipses \
	find=best1 fixcols=dups suffix1=null suffix2=_summ join=1and2 matcher=skyellipse \
	...
	ofmt=fits-basic omode=out out=DR4AllDetections_inUnKnownEllipses_major
stilts tmatch2 \
       in1=DR4AllDetections_inUnKnownEllipses_major \
       in2=DR4AllDetections_inUnKnownEllipses_minor \
       find=best fixcols=none  join=1not2 matcher=exact \
       values1='DETID' values2='DETID' \
       ofmt=fits-basic omode=out out=DR4AllDetections_inUnKnownEllipses_major
rm Good_RC3_CNG_5sec_NED_30sec_KnownDist_minDlt25min_summaryDR4_30min_unKnownEllipses
# Concatenate the three tables and detect bad distance estimations.
stilts tcat in='DR4AllDetections_inKnownEllipses DR4AllDetections_inUnKnownEllipses_minor DR4AllDetections_inUnKnownEllipses_major' \
	ofmt=fits-basic omode=out out=DR4AllDetections_inGalaxies \
...
rm DR4AllDetections_inKnownEllipses
rm DR4AllDetections_inUnKnownEllipses_minor
rm DR4AllDetections_inUnKnownEllipses_major
# Eradicate duplicate detections by keeping the version that is closest to the center of their home.
stilts tmatch1 \
	in=DR4AllDetections_inGalaxies \
	matcher=exact values='DETID' action=keep1\
	ofmt=fits-basic omode=out out=DR4AllDetections_inGalaxies
# Eradicate all central Detections.
stilts tpipe in=DR4AllDetections_inGalaxies \
	ofmt=fits-basic omode=out out=DR4AllDetections_inGalaxies_nonCentral \
	cmd='select "SC_MinCenterDist>3"' \
	cmd='sort SC_CenterDist'
# Identify all detections of the same (assumed) source
rm DR4AllDetections_inGalaxies
stilts tmatch1 \
	in=DR4AllDetections_inGalaxies_nonCentral \
	matcher=exact values='SRCID' action=identify\
	ofmt=fits-basic omode=out out=DR4AllDetections_inGalaxies_nonCentral
# Eradicate Detections found in catalogues of known stars and QSO.
stilts tmatch2 \
	in1=DR4AllDetections_inGalaxies_nonCentral \
	in2=VeronQSO/VeronQSO \
	matcher=sky join=1not2 find=best2 \
	values1='SC_RA SC_DEC' values2='_RAJ2000 _DEJ2000' params=10 \
	ofmt=fits-basic omode=out out=DR4AllDetections_inGalaxies_nonCentral_noQSO
rm DR4AllDetections_inGalaxies_nonCentral
stilts tmatch2 \
	in1=DR4AllDetections_inGalaxies_nonCentral_noQSO \
	in2=Tycho2/Tycho2 \
	matcher=sky join=1not2 find=best2 \
	values1='SC_RA SC_DEC' values2='_RAJ2000 _DEJ2000' params=10 \
	ofmt=fits-basic omode=out out=DR4AllDetections_inGalaxies_nonCentral_noQSOnoSO
rm DR4AllDetections_inGalaxies_nonCentral_noQSO
# Identify all detections of the same (assumed) source and eradicate those that have had one source erased.
stilts tmatch1 \
	in=DR4AllDetections_inGalaxies_nonCentral_noQSOnoSO \
	matcher=exact values='SRCID' action=identify\
	ofmt=fits-basic omode=out out=DR4AllDetections_inGalaxies_nonCentral_noQSOnoSO \
...
stilts tpipe in=DR4AllDetections_inGalaxies_nonCentral_noQSOnoSO \
	ofmt=fits-basic omode=out out=DR4AllDetections_inGalaxies_nonCentral_noQSOnoSO_lowFlag \
	cmd='select SUM_FLAG<=1' cmd='sort SRCID'
rm DR4AllDetections_inGalaxies_nonCentral_noQSOnoSO
